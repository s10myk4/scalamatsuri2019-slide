[![GitPitch](https://gitpitch.com/assets/badge.svg)](https://gitpitch.com/gitpitch/in-60-seconds/master?grs=gitlab)
...
> Tutorial also available for [GitHub](https://github.com/gitpitch/in-60-seconds) and [Bitbucket](https://bitbucket.org/gitpitch/in-60-seconds) users.

### Introduction

As a *GitLab* user you are probably familiar with the **README.md** convention.
A convention that automatically turns any **README.md** file found within a
*GitLab* repository into nicely rendered project documentation on *gitlab.com*.

GitPitch introduces a brand new convention for all *GitLab* users, the
**PITCHME.md** convention.

This new convention automatically turns any **PITCHME.md** file found within a *GitLab* repository into a modern, responsive slide deck that is automatically available for sharing and presenting directly on
...
your own *GitLab* account. Within your new repository you will find the basic
...
```
https://gitpitch.com/$USER/in-60-seconds?grs=gitlab
```

> You must substitute **your** *GitLab* account name for `$USER` in the above slideshow URL.
...
> For comparison purposes, the slideshow URL for the GitPitch In-60-Seconds sample presentation associated with the *gitpitch* GitLab account can be launched [here](https://gitpitch.com/gitpitch/in-60-seconds?grs=gitlab).
