...
* TODO: このフェーズでは以下を説明する
    * 目的
        * 前フェーズの要求(望んでいること。何を作りたいか)に対して分析を行い、仕様(ふるまい/制約)を定義する
...
前フェーズで要求を導き出しました。このフェーズではその要求に対して分析を行い、仕様、すなわち振る舞いと制約を定義します。要求を正しく理解していないと仕様が定まりません。
...
異常系まで含めて定義しておくことで、仕様未定義によるバグをより体系的に防ぐことができます。
